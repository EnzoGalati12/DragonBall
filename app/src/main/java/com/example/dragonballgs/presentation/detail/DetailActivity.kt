...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.dragonData.observe(this, Observer { dragon ->
            ...
            binding.tvKi.text = dragon.ki
            binding.tvMaxKi.text = dragon.maxKi
            binding.tvAffiliation.text = dragon.affiliation

            // Carrega a imagem no ImageView usando Glide
            Glide.with(this)
                .load(dragon.image) // Substitua `dragon.imageUrl` pelo nome correto do campo da URL da imagem
